...
const ProgressCardReport = () => {
  const sidebarItems = getAdminSidebarItems("/admin/reports/exam/progress-card");
  ...
  return (
    <DashboardLayout title="Progress Card Report" userName="Admin" userRole="Administrator" sidebarItems={sidebarItems}>
      <div className="p-4">
        <Card>
          <CardHeader>
