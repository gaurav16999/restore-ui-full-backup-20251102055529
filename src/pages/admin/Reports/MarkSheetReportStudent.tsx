...
const MarkSheetReportStudent = () => {
  const sidebarItems = getAdminSidebarItems("/admin/reports/exam/mark-sheet");
  ...
  return (
    <DashboardLayout title="Mark Sheet Report Student" userName="Admin" userRole="Administrator" sidebarItems={sidebarItems}>
      <div className="p-4">
        <Card>
          <CardHeader>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 items-end">
              ...
              <div className="flex flex-col items-end">
                <div className="w-full">
                  ...
                  <select className="w-full border border-red-400 rounded px-3 py-2">
                  ...
                  <div className="text-xs text-red-500 mt-1">The student field is required.</div>
                </div>
        ...
        {/* design shows empty area below criteria; leave placeholder for table */}
        <div className="mt-6" />
      </div>
    </DashboardLayout>
  );
...
export default MarkSheetReportStudent;
