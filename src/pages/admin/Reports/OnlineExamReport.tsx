...
const OnlineExamReport = () => {
  const sidebarItems = getAdminSidebarItems("/admin/reports/exam/online");
  ...
  return (
    <DashboardLayout title="Online Exam Report" userName="Admin" userRole="Administrator" sidebarItems={sidebarItems}>
      <div className="p-4 space-y-6">
        ...
        {/* placeholder space like design (no table shown in screenshot) */}
        <div className="mt-6" />
      </div>
    </DashboardLayout>
  );
