...
const FeesFineReport = () => {
  const sidebarItems = getAdminSidebarItems("/admin/reports/fees/fine");
  ...
  return (
    <DashboardLayout title="Fine Report" userName="Admin" userRole="Administrator" sidebarItems={sidebarItems}>
