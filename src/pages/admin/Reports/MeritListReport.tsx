...
import { examApi, classApi, classRoomApi } from "@/services/adminApi";

const MeritListReport = () => {
  const sidebarItems = getAdminSidebarItems("/admin/reports/exam/merit-list");
  ...
  return (
    <DashboardLayout title="Merit List Report" userName="Admin" userRole="Administrator" sidebarItems={sidebarItems}>
      <div className="p-4">
        <Card>
          <CardHeader>
        ...
        {/* The design shows an empty area beneath the criteria; keep placeholder for future table */}
        <div className="mt-6" />
      </div>
    </DashboardLayout>
  );
