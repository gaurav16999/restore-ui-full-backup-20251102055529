...
const WaiverReport = () => {
  const sidebarItems = getAdminSidebarItems("/admin/reports/fees/waiver");
  ...
  return (
    <DashboardLayout title="Waiver Report" userName="Admin" userRole="Administrator" sidebarItems={sidebarItems}>
