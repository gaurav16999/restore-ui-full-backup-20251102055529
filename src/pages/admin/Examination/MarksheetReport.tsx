...
const MarksheetReport = () => {
  const sidebarItems = getAdminSidebarItems("/admin/examination/marksheet-report");
  ...
  const handleSearch = () => {
    console.log('search marksheet', { exam, subject, klass, section });
  };

  return (
    <DashboardLayout title="Marksheet Report" userName="Admin" userRole="Administrator" sidebarItems={sidebarItems}>
