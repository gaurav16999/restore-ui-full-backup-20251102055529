...
const ExamAttendance = () => {
  const sidebarItems = getAdminSidebarItems("/admin/examination/attendance");
  ...
  const handleSearch = () => {
    console.log('search attendance', { exam, klass, subject, section });
  };
  ...
  return (
    <DashboardLayout title="Exam Attendance" userName="Admin" userRole="Administrator" sidebarItems={sidebarItems}>
            ...
            <Card>
              <CardHeader>
                <div className="flex items-start justify-between w-full">
                  ...
                  <div className="ml-4">
                    <Button className="bg-purple-600 border-transparent text-white hover:bg-purple-700" onClick={handleCreate}>＋ ATTENDANCE CREATE</Button>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
