              ...
              <TableBody>
                {Array.isArray(rows) && rows.length > 0 ? (
                  rows.map((r, idx) => (
                    <TableRow key={idx}>
                      <TableCell>
                        <span className="text-base font-semibold bg-purple-50 dark:bg-purple-900/20 px-3 py-1.5 rounded-md tracking-wide">
                          {r.employee_id || `25${String(idx + 1).padStart(6, '0')}`}
                        </span>
                      </TableCell>
                      <TableCell className="font-medium">
                        <div className="flex flex-col">
                          ...
                          <span className="text-xs text-muted-foreground font-normal">
                            ID: {r.employee_id || `25${String(idx + 1).padStart(6, '0')}`}
                          </span>
                        </div>
                      </TableCell>
                      <TableCell>{r.designation_name || r.designation || '-'}</TableCell>
                      <TableCell>{r.department_name || r.department || '-'}</TableCell>
                      <TableCell>{r.designation_name || '-'}</TableCell>
                      <TableCell>{r.phone || r.mobile || '-'}</TableCell>
