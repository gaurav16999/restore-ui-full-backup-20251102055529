...
const AdmitCard = () => {
  const sidebarItems = getAdminSidebarItems("/admin/exam-plan/admit-card");
  ...
  const handleSearch = () => {
    console.log('search admit card', { exam, klass, section });
  };

  return (
    <DashboardLayout title="Generate Admit Card" userName="Admin" userRole="Administrator" sidebarItems={sidebarItems}>
