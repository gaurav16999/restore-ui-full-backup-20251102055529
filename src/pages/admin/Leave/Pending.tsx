...
const PendingLeave = () => {
  const sidebarItems = getAdminSidebarItems("/admin/leave/pending");
  const [quickSearch, setQuickSearch] = useState("");
  const rows: any[] = [];

  return (
    <DashboardLayout title="Pending Leave Request" userName="Admin" userRole="Administrator" sidebarItems={sidebarItems}>
