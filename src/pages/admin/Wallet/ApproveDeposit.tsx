...
const ApproveDeposit = () => {
  const sidebarItems = getAdminSidebarItems("/admin/wallet/approve-deposit");

  return (
    <DashboardLayout title="Approve Deposit" userName="Admin" userRole="Administrator" sidebarItems={sidebarItems}>
          ...
          <CardContent>
            <Table>
              ...
              <TableBody>
                ...
                <TableRow>
                  <TableCell colSpan={9} className="text-center text-sm text-muted-foreground">Result</TableCell>
                </TableRow>
              </TableBody>
            </Table>
