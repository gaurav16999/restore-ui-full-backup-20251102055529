...
const ApprovedReport = () => {
  const sidebarItems = getAdminSidebarItems("/admin/teacher-evaluation/approved-report");
  ...
  const handleSearch = () => {
    console.log('search approved evaluation', { klass, subject, section, teacher, submittedBy });
  };

  const rows: any[] = [];

  return (
    <DashboardLayout title="Teacher Approved Evaluation Report" userName="Admin" userRole="Administrator" sidebarItems={sidebarItems}>
