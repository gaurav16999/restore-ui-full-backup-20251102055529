...
const sampleRows = [
  { si: 1, name: "Fund Transfer", method: "Cash", date: "27th Oct, 2025", head: "-", amount: 5000 },
];

const formatCurrency = (v: number) => v.toLocaleString("en-US", { style: "currency", currency: "USD" });

const Expense = () => {
  const sidebarItems = getAdminSidebarItems("/admin/accounts/expense");

  return (
    <DashboardLayout title="Add Expense" userName="Admin" userRole="Administrator" sidebarItems={sidebarItems}>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-2">(PDF, DOC, DOCX, JPG, JPEG, PNG, TXT are allowed for upload)</p>
                  </div>
                  ...
                  <div className="mt-4">
                    <Button className="bg-purple-600 text-white">✓ SAVE EXPENSE</Button>
                  </div>
                </div>
              </CardContent>
            </Card>
