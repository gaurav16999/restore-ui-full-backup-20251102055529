...
const DashboardLayout = ({
  ...
  <div className="flex">
        ...
        <aside
          ...
          } fixed lg:translate-x-0 left-0 z-40 w-64 bg-slate-800 border-r border-slate-700 transition-transform duration-300 lg:mt-0 shadow-xl`}
          style={{ top: 'var(--app-header-height)', bottom: 0 }}
          role="navigation"
          aria-label="Main sidebar"
        >
          <nav className="p-4 space-y-1.5 overflow-y-auto" style={{ height: 'calc(100vh - var(--app-header-height))' }}>
        ...
        {/* Main Content */}
        <main
          className="flex-1 p-4 md:p-6 bg-gray-50 overflow-y-auto lg:ml-64"
          style={{ height: 'calc(100vh - var(--app-header-height))' }}
        >
          <div className="max-w-7xl mx-auto w-full lg:mx-0 lg:pl-6">
            {children}
          </div>
        </main>
      </div>
