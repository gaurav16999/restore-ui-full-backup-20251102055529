...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        student_data = [{'username': 'emma.wilson',
                         'first_name': 'Emma',
                         'last_name': 'Wilson',
        ...
        teacher_data = [{'username': 'prof.anderson',
                         'first_name': 'Michael',
                         'last_name': 'Anderson',
        ...
        activity_data = [{'action': 'New student enrolled',
                          'user': 'John Doe',
                          'activity_type': 'enrollment'},
                         {'action': 'Teacher assigned to Class 10A',
                          'user': 'Jane Smith',
        ...
        event_data = [{'title': 'Parent-Teacher Meeting',
