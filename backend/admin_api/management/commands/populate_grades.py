...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        grade_types = ['Assignment', 'Quiz', 'Test', 'Project', 'Homework', 'Midterm', 'Final']
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f'Successfully created {grades_created} sample grades for {students.count()} students across {subjects.count()} subjects'
            )
        )