...
class FeeStructureViewSet(viewsets.ModelViewSet):
    ...
    def stats(self, request):
        ...
        mandatory_fees = FeeStructure.objects.filter(is_active=True, is_mandatory=True).count()
...
class FeePaymentViewSet(viewsets.ModelViewSet):
    ...
    filter_backends = [filters.SearchFilter, filters.OrderingFilter]
    search_fields = ['invoice_number', 'student__user__first_name', 'student__user__last_name', 'student__roll_no']
    ...
    def stats(self, request):
        ...
        total_pending = FeePayment.objects.filter(status__in=['pending', 'partial']).count()
