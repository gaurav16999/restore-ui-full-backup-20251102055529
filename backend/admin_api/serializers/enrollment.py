...
class EnrollmentSerializer(serializers.ModelSerializer):
    ...
    classroom_grade = serializers.CharField(source='classroom.grade_level', read_only=True)
    classroom_section = serializers.CharField(source='classroom.section', read_only=True)
...
class EnrollmentListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Enrollment
        fields = ['id', 'student_name', 'classroom_name', 'enrollment_date', 'is_active']
