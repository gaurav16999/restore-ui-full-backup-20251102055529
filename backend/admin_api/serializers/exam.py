...
class ExamScheduleSerializer(serializers.ModelSerializer):
    ...
    invigilator_name = serializers.CharField(source='invigilator.user.get_full_name', read_only=True, allow_null=True)
...
class ExamResultSerializer(serializers.ModelSerializer):
    ...
    entered_by_name = serializers.CharField(source='entered_by.user.get_full_name', read_only=True, allow_null=True)
...
class ExamResultCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ExamResult
        fields = ['student', 'exam', 'subject', 'marks_obtained', 'max_marks', 'grade', 
                  'remarks', 'is_absent', 'entered_by']
