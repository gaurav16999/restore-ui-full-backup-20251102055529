...
from admin_api.models import Student, Class, Grade, Subject, Attendance
...
class DashboardView(APIView):
    ...
    def get(self, request):
        try:
            ...
            avg_grade = round(sum([float(g.score) for g in grades]) / len(grades), 1) if grades else 0
            ...
            'weekly_schedule': [
                {
                    'day': 'Monday',
                    'classes': [
                        {'subject': 'Mathematics', 'time': '9:00 AM - 10:00 AM', 'room': 'Room 201', 'teacher': 'Prof. Anderson'},
                        {'subject': 'Chemistry', 'time': '2:00 PM - 3:00 PM', 'room': 'Lab 2', 'teacher': 'Ms. Davis'}
                    ]
                },
                {
                    ...
                    'classes': [
                        {'subject': 'Physics', 'time': '10:30 AM - 11:30 AM', 'room': 'Lab 3', 'teacher': 'Dr. Johnson'},
                        {'subject': 'English', 'time': '1:00 PM - 2:00 PM', 'room': 'Room 105', 'teacher': 'Ms. Wilson'}
                    ]
                },
                {
                    'day': 'Wednesday',
                ...
                },
                {
                    ...
                    'classes': [
                        {'subject': 'Physics', 'time': '10:30 AM - 11:30 AM', 'room': 'Lab 3', 'teacher': 'Dr. Johnson'},
                        {'subject': 'History', 'time': '3:00 PM - 4:00 PM', 'room': 'Room 203', 'teacher': 'Mr. Brown'}
                    ]
                },
                {
                    'day': 'Friday',
                    'classes': [
                        {'subject': 'Mathematics', 'time': '9:00 AM - 10:00 AM', 'room': 'Room 201', 'teacher': 'Prof. Anderson'},
                        {'subject': 'Biology', 'time': '11:00 AM - 12:00 PM', 'room': 'Lab 1', 'teacher': 'Dr. Green'}
                    ]
                }
            ]
        }
...
class AttendanceView(APIView):
    ...
    def get(self, request):
        try:
            ...
            overall_percentage = round((present_count / total_attendance * 100), 1) if total_attendance > 0 else 0
